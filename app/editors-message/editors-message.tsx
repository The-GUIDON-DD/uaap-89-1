    ...
    >
      ...
      <div className="relative flex size-full flex-col justify-end overflow-hidden bg-black px-6 pb-12 pt-20 md:hidden">
        ...
        <img
          ...
          src="/editors.webp"
          className="absolute left-1/2 top-[4%] h-[52%] max-w-none -translate-x-1/2"
          style={{
            maskImage:
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to top, #000 0%, #000 55%, rgba(0,0,0,0.85) 66%, rgba(0,0,0,0.55) 78%, rgba(0,0,0,0.25) 89%, rgba(0,0,0,0) 100%)",
          }}
        />
